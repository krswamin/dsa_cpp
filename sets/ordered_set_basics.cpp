...
int main() {
  set<string> set1 = {"Krithika", "random", "Vasanthi", "Swaminathan"};

  cout << "\n set: before modifications (notice that it is sorted in ascending "
          "order)  \n";
  for (auto x : set1) {
    cout << x << "\n";
  }
  ...
  cout << "\n\n set: after modifications (notice that it is sorted in "
          "ascending order) \n";
  for (auto x : set1) {
    cout << x << "\n";
  }
