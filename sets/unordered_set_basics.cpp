...
int main(){
     unordered_set <string> set1 = {"Krithika",
                          "random",
                          "Vasanthi",
                          "Swaminathan"
                          };
    
    cout<<"\n Unordered Set: before modifications (notice that it is NOT sorted)  \n";
    for (auto x: set1){
        cout<<x<<"\n";
    }
    ...
    cout<<"\n\n Unordered Set: after modifications (notice that it is NOT sorted) \n";
    for (auto x: set1){
        cout<<x<<"\n";
    }
