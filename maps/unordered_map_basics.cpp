...
int main(){
     unordered_map <int,string> map1 = {{11,"Krithika"},
                          {53,"random"},
                          {17,"Vasanthi"},
                          {23,"Swaminathan"}
                          };
    
    cout<<"\n Unordered Map: before modifications (notice that it is NOT sorted) \n";
    for (auto x: map1){
    ...
    cout<<"\n\n Unordered Map: after modifications (notice that it is NOT sorted)  \n";
    for (auto x: map1){
        cout<<x.first<<":"<<x.second<<"\n";
    }
