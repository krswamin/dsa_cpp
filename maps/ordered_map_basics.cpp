...
int main(){
     map <int,string> map1 = {{11,"Krithika"},
                          {53,"random"},
                          {17,"Vasanthi"},
                          {23,"Swaminathan"}
                          };
    
    cout<<"\n Map: before modifications (notice that it is sorted in ascending order)  \n";
    for (auto x: map1){
    ...
    cout<<"\n\n Map: after modifications (notice that it is sorted in ascending order) \n";
    for (auto x: map1){
        cout<<x.first<<":"<<x.second<<"\n";
    }
