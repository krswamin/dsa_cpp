...
class Vertex{
    ...
    public: 
        Vertex(unsigned int index, int value, vector<unsigned int> indices_connected_to);
        void print_vertex();
};

Vertex::Vertex(unsigned int index, int value, vector<unsigned int> indices_connected_to) {
    this->index = index;
    this->value = value;
