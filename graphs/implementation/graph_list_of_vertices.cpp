...
public:
  Graph();
  Graph(const vector<unsigned int> &indices, const vector<int> &values,
...
Graph::Graph(const vector<unsigned int> &indices, const vector<int> &values,
             const vector<optional<vector<unsigned int>>> &connections) {
...
int main() {
  ...
  vector<optional<vector<unsigned int>>> connections = {
      vector<unsigned int>{1, 2}, vector<unsigned int>{3},
      vector<unsigned int>{3}, nullopt};
